...
import RegistVoide from "../../components/Game/GameContents/RegistVoice";
...
function Game() {
    ...
    return (
        <BackGroundImg style={{overflow:"hidden"}}>
            ...
            <Container>
                {
                    pageState == 0 ? <GameMain SetPageMafia={()=>HandlePageState(1)} SetPageRegist={()=>HandlePageState(2)}/>
                    : pageState == 1 ?<GameContents/> : <RegistVoide/>
                }
            </Container>
