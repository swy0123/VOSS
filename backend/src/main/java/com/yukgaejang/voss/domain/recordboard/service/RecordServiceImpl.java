...
public class RecordServiceImpl implements RecordService {
    ...
    @Override
    public UpdateRecordResponse updateRecord(Long recordId, UpdateRecordRequest updateRecordRequest) {
    ...
    @Override
    public RecordDetailResponse getRecordDetail(String email, Long recordId) {

        return null;
    }

    @Override
    public Page<RecordListResponse> getRecordList(String description, String nickname, String sort, Pageable pageable) {
        return null;
    }

    @Override
    public DeleteRecordResponse deleteRecord(Long recordId) {
        return null;
    }
}
